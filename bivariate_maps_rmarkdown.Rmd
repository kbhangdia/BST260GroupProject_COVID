...
First we made a new variable for % f population >65 years 
```{r}
...
The we mutated into categorical variables 1-3 to represent the three quantiles for each variable 
```{r}
...
The we transformed the indicator variables to be numeric 
```{r}
